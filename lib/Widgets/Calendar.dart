...
class CalendarApp extends StatefulWidget {
  @override
  _CalendarAppState createState() => new _CalendarAppState();
}

class _CalendarAppState extends State<CalendarApp> {
  DateTime _currentDate = DateTime(2020, 10, 6);
  DateTime _currentDate2 = DateTime(2020, 10, 6);
  String _currentMonth = DateFormat.yMMMM().format(DateTime(2020, 10, 6));
  DateTime _targetDateTime = DateTime(2020, 10, 6);
